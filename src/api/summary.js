...
// 获取部门日历组件有请假的日期
export function getMonthDeptLeaveDate(data) {
  return request({
    url: '/history/getMonthDeptLeaveDate',
    method: 'get',
    params: data
  })
}
...
//某学院不同月份考勤信息汇总
export function getLeaveHistoryByMonthAndDept(data) {
  return request({
    url: '/history/getLeaveHistoryByMonthAndDept',
    method: 'get',
    params: data
  })
}