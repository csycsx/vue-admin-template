  ...
  <div class="app-container">
    ...
    <el-card style="background-color:#f9fafc">
      ...
      <template slot-scope="scope">
        ...
        size="mini"
        type="danger"
        @click="deleteUsers(scope.row.id)">删除</el-button>
      </template>
      </el-table-column>
      </el-table>
...
import { getUser, addUserTo, deleteUserFrom } from '@/api/admin'
export default {
    data() {
      return {
        userlist:[],
        ...
        addFormRules:{
          userid:[
            ...
            {min:3,max:10,massage:'长度需在2-10个字符之间',trigger:'blur'},
          ],
          username:[
    ...
    methods: {
      ...
      async deleteUsers(id){
        console.info(id)
        let params={'id':'1'}
        deleteUserFrom(params).then((response)=>{
