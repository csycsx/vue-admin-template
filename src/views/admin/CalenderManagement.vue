 ...
 <div class="app-container">
    ...
    <!-- 修改信息 -->
     ...
     <el-form-item label="描述信息"  :label-width="formLabelWidth" prop='description'>
      ...
      <el-form-item label="开始日期"  :label-width="formLabelWidth1" prop="holidayStartDate">
      <el-input v-model="editForm.holidayStartDate" type="date"  style="width: 108%"></el-input>
      </el-form-item>
      <el-form-item label="结束日期"  :label-width="formLabelWidth1" prop="holidayEndDate">
   ...
   <!-- 新增信息 -->
    <el-dialog 
      ...
      <el-form-item label="管理员"    prop='adminId' >
        <el-input v-model="addForm.adminId" style="width: 50%"></el-input>
      </el-form-item>
      ...
      <el-form-item label="开始日期"   prop='holidayStartDate'>
      <el-input v-model="addForm.holidayStartDate" type="date" style="width: 46%"></el-input>
      </el-form-item>
      <el-form-item label="结束日期"  prop='holidayEndDate'>
        <el-input v-model="addForm.holidayEndDate" type="date" style="width: 46%"></el-input>
      </el-form-item>
      </el-form>
...
import { getcalenderList,deletecalenderFrom,updatecalenderForm,addVocationTo ,findAdjustById} from '@/api/admin'
export default {
  data() {
    return {
      //获取列表的参数对象
